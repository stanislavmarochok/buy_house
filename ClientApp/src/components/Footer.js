    ...
    <footer>
        ...
        <section className=''>
            ...
            <MDBRow className='mt-3'>
                ...
                <h6 className='text-uppercase fw-bold mb-4'> <MDBIcon icon="gem" className="me-3" /> Company name </h6>
        ...
        <div className='text-center p-4' style={{ backgroundColor: 'rgba(0, 0, 0, 0.05)' }}> © 2021 Copyright:
